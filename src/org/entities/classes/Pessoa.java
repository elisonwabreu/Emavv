...
public abstract class Pessoa {
    ...
    protected String fd_nome;
    protected String fd_cpf;
    protected String fd_rg;
    protected String fd_dataNascimento;
    protected String fd_sexo;
    protected String fd_endereco;
    protected int fd_numero;
    protected String fd_bairro;
    protected String fd_cep;
    protected String fd_cidade;
    protected String fd_uf;
    protected String fd_telefone;
    protected String fd_celular;
    protected String fd_email;
    protected String fd_status;
    ...
    public String getFd_dataNascimento() {
        return fd_dataNascimento;
    }

    public void setFd_dataNascimento(String fd_dataNascimento) {
        this.fd_dataNascimento = fd_dataNascimento;
    }
